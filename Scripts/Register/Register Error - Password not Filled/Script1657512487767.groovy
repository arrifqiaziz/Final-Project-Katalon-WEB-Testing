...
WebUI.setText(findTestObject('Page Register/Input Password'), '')

WebUI.setText(findTestObject('Page Register/Input Confirm Password'), '')

WebUI.setText(findTestObject('Page Register/Input Address'), 'Bogor')

WebUI.click(findTestObject('Page Register/btn Register'))

WebUI.verifyElementPresent(findTestObject('Page Register/Error Password is required'), 1)
